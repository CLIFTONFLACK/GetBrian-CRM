-- 0034 (originally 0033): London neighbourhood / fare-zone requirement targets +
-- leisure use classes.
--
...
--    them; 0035 migrates those rows) but are no longer offered on the form —
--    agents brief in trading terms, not planning terms.
--
-- The ADD VALUEs and the backfill that uses them must be in separate
-- transactions, so the data migration lives in 0035.
